...
# Load dataset
file_path = "C:\\Users\\maney\\\AppData\\Local\\Programs\\Python\\Python313\\spam.csv"  # Update this path if needed
try:
    df = pd.read_csv("C:\\Users\\maney\\\AppData\\Local\\Programs\\Python\\Python313\\spam.csv", encoding="latin-1")
